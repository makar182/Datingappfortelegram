  ...
  const steps = [
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p className="text-gray-700">
            Незнакомым людям предлагалось ответить на 36 постепенно углубляющихся вопросов. 
    ...
    {
      icon: Heart,
      title: '36 вопросов для эмоциональной близости',
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white p-3.5 rounded-xl border border-emerald-200 flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Специально подготовленные вопросы позволят следовать принципу легендарного эксперимента Артура Арона</p>
              </div>
            </div>
            <div className="bg-white p-3.5 rounded-xl border border-emerald-200 flex items-start gap-3">
              <span className="text-xl">🤝</span>
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-700">
            ...
            Поэтому в нашем приложении действует особое правило:
          </p>
          ...
          <div className="bg-white p-5 rounded-2xl border border-gray-200">
            ...
            <p className="text-gray-600 mt-2">
              Вы можете вести только один чат за раз
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white p-3.5 rounded-xl border border-gray-200">
              ...
              <p className="text-gray-600 mt-1">
                Пока вы проходите эксперимент с одним человеком, другие приглашения остаются доступны после завершения текущего чата
              </p>
            </div>
            ...
            <div className="bg-white p-3.5 rounded-xl border border-red-200">
              ...
              <p className="text-gray-600 mt-2">
                Если вы начнёте новый чат, предыдущий будет безвозвратно удалён.
              </p>
              <p className="text-gray-800 mt-2 text-center">
                <strong>Уходя - уходи</strong>
              </p>
            </div>
          </div>
        </div>
